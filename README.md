...
> 🚀 live version of dev https://angular-assessment-sashen.vercel.app/
...
- effect handles side effects (syncing audio element, persisting to IndexedDB)

**Disadvantages**
- No built in devtools for time-travel debugging
- No enforced unidirectional data flow
- RxJS still needed at the boundary where third-party libraries emit observables (Auth0 uses isAuthenticated, user), toSignal was used to kinda bridge without spreading RxJS further into the app
